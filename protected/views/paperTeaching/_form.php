...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row" id="authors">
        ...
        for($i=0;$i<5;$i++) {
            ...
            $select='<select name="PaperTeaching'.'[peoples]['.$i.']'.'">';
    ...
    <div class="row">
        ...
        echo CHtml::dropDownList(
            'PaperTeaching[achivement_projects]',
            array(),
            Chtml::listData($projects, 'id', 'name'),
            array(
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        changeInputByStatus(parseInt($('#PaperTeaching_status').val()));
        $('#PaperTeaching_status').change(function(){
