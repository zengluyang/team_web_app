...
class People extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'patents' => array(self::MANY_MANY, 'Patent', 'tbl_patent_people(people_id, patent_id)'),
            'papers' => array(self::MANY_MANY, 'paper', 'tbl_paper_people(people_id, paper_id)'),
		);
	}
