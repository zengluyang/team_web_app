...
class AwardController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow',
				...
				'expression'=>'isset($user->is_award) && $user->is_award',
			),
			array('allow', 
	...
	private function setModelRelation($model) {
		if(isset($_POST['Award']['peoples_value']))
			$model->peopleIds=explode(',', $_POST['Award']['peoples_value']);
	}
	 ...
	 * @param Award $model the model to be validated
	 */
    ...
    public function saveXlsArrayToDb($projects)
    {
        ...
        foreach($projects as $k => $p) {
            ...
            if(($project=Award::model()->findByAttributes(array('project_name'=>$p[0],'award_name'=>$p[1])))==null) {
            	$project = new Award;
            }
